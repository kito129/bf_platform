...
/* harmony import */ var _model_newStudy_rule_rules__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../../../model/newStudy/rule/rules */ "zZp8");
...
let RuleEditComponent = class RuleEditComponent {
    ...
    ngOnInit() {
        this.myForm = this.fb.group({
            ...
            rule: this.fb.array([this.generateNewRule(new _model_newStudy_rule_rules__WEBPACK_IMPORTED_MODULE_4__["Rule"]('1'))], [
                _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required,
            ])
        });
        // this.onChanges();
    ...
    addRule() {
        this.rules.push(this.generateNewRule(new _model_newStudy_rule_rules__WEBPACK_IMPORTED_MODULE_4__["Rule"](`${this.rules.length + 1}`)));
    ...
    resetRule(i) {
        ...
        this.rules.controls[i].patchValue(new _model_newStudy_rule_rules__WEBPACK_IMPORTED_MODULE_4__["Rule"](`${i + 1}`));
    }
    upRule(i) {
        if (i > 0) {
...
/* harmony import */ var _players_players_main_component__WEBPACK_IMPORTED_MODULE_34__ = __webpack_require__(/*! ./players/players-main.component */ "czgd");
/* harmony import */ var _players_components_players_list_players_list_component__WEBPACK_IMPORTED_MODULE_35__ = __webpack_require__(/*! ./players/components/players-list/players-list.component */ "ymH9");
/* harmony import */ var _players_components_players_create_players_create_component__WEBPACK_IMPORTED_MODULE_36__ = __webpack_require__(/*! ./players/components/players-create/players-create.component */ "m6kr");
/* harmony import */ var _new_rule_rule_component__WEBPACK_IMPORTED_MODULE_37__ = __webpack_require__(/*! ./new/rule/rule.component */ "wtyO");
/* harmony import */ var _new_rule_rule_list_rule_list_component__WEBPACK_IMPORTED_MODULE_38__ = __webpack_require__(/*! ./new/rule/rule-list/rule-list.component */ "X6/f");
/* harmony import */ var _new_rule_rule_edit_rule_edit_component__WEBPACK_IMPORTED_MODULE_39__ = __webpack_require__(/*! ./new/rule/rule-edit/rule-edit.component */ "5Mzo");
...
StudyModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        declarations: [
            ...
            _players_players_main_component__WEBPACK_IMPORTED_MODULE_34__["PlayersMainComponent"],
            _players_components_players_list_players_list_component__WEBPACK_IMPORTED_MODULE_35__["PlayersListComponent"],
            _players_components_players_create_players_create_component__WEBPACK_IMPORTED_MODULE_36__["PlayersCreateComponent"],
            _new_rule_rule_component__WEBPACK_IMPORTED_MODULE_37__["RuleComponent"],
            _new_rule_rule_list_rule_list_component__WEBPACK_IMPORTED_MODULE_38__["RuleListComponent"],
            _new_rule_rule_edit_rule_edit_component__WEBPACK_IMPORTED_MODULE_39__["RuleEditComponent"],
        ],
        imports: [
...
/* harmony import */ var _model_utils__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../../../../model/utils */ "E8uS");
/* harmony import */ var _model_report_strategyReport__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../../../../model/report/strategyReport */ "TQzV");
...
let StudyComparatorComponent = class StudyComparatorComponent {
    ...
    generateStrategyReports(data) {
        for (const study of data) {
            const tempReport = new _model_report_strategyReport__WEBPACK_IMPORTED_MODULE_6__["StrategyReportClass"]();
...
/* harmony import */ var _model_report_strategyReport__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../../model/report/strategyReport */ "TQzV");
