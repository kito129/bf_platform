        ...
        _createClass(RuleEditComponent, [{
          ...
          value: function ngOnInit() {
            this.myForm = this.fb.group({
              ...
              rule: this.fb.array([this.generateNewRule(new _model_study_new_rule_rules__WEBPACK_IMPORTED_MODULE_4__["Rule"]('1'))], [_angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required])
            }); // this.onChanges();
          }
        }, {
          key: "name",
          ...
          value: function addRule() {
            this.rules.push(this.generateNewRule(new _model_study_new_rule_rules__WEBPACK_IMPORTED_MODULE_4__["Rule"]("".concat(this.rules.length + 1))));
          ...
          value: function resetRule(i) {
            ...
            this.rules.controls[i].patchValue(new _model_study_new_rule_rules__WEBPACK_IMPORTED_MODULE_4__["Rule"]("".concat(i + 1)));
          }
        }, {
          key: "upRule",
          ...
          value: function generateSubTrades(data) {
            ...
            try {
              for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
                ...
                var avgDDPercent = this.utils.avgOfArrayNumber(ddPercent); // set to local props
      ...
      var getTradeById = function getTradeById(id) {
        return Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createSelector"])(getStudyState, function (state) {
          var response = state.compareStudies.map(function (x) {
            return x.trades.filter(function (y) {
              return y._id === id;
            })[0];
          });
