(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([[10], {
    ...
    function CfRl(module, __webpack_exports__, __webpack_require__) {
      ...
      var _components_statistic_main_statistic_main_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(
      /*! ./components/statistic-main/statistic-main.component */
      "npqK");
      /* harmony import */


      var _components_statistic_table_statistic_table_component__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(
      /*! ./components/statistic-table/statistic-table.component */
      "Pxo9"); // MAIN IMPORT
      // DEPENDENCIES IMPORT
      // Ng-ApexCharts
      // Ng2-trade
      ...
      NotesModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        declarations: [_components_notes_main_notes_main_component__WEBPACK_IMPORTED_MODULE_10__["NotesMainComponent"], _components_statistic_main_statistic_main_component__WEBPACK_IMPORTED_MODULE_15__["StatisticMainComponent"], _components_statistic_table_statistic_table_component__WEBPACK_IMPORTED_MODULE_16__["StatisticTableComponent"]],
        exports: [],
    ...
    /***/
    function JVx0(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_exports__["default"] = "<p>statistic-table works!</p>\n";
      /***/
    },
    ...
    /***/
    function Pxo9(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "StatisticTableComponent", function () {
        return StatisticTableComponent;
      });
      /* harmony import */
      ...
      var _raw_loader_statistic_table_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./statistic-table.component.html */
      "JVx0");
      /* harmony import */
      ...
      var StatisticTableComponent = /*#__PURE__*/function () {
        function StatisticTableComponent() {
          _classCallCheck(this, StatisticTableComponent);
        }

        _createClass(StatisticTableComponent, [{
          key: "ngOnInit",
          value: function ngOnInit() {}
        }]);
      ...
      StatisticTableComponent.ctorParameters = function () {
        return [];
      };

      StatisticTableComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
    ...
    /***/
    function ggkN(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function npqK(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "StatisticMainComponent", function () {
        return StatisticMainComponent;
      });
      /* harmony import */
      ...
      var _raw_loader_statistic_main_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./statistic-main.component.html */
      "ggkN");
      /* harmony import */
      ...
      var _model_calculator_utils__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ../../../../model/calculator/utils */
      "VvVk");

      var StatisticMainComponent = /*#__PURE__*/function () {
        function StatisticMainComponent() {
          _classCallCheck(this, StatisticMainComponent);
          ...
          this.avgRetired = '0';
          this.avgNoMed = '0';
          this.util = new _model_calculator_utils__WEBPACK_IMPORTED_MODULE_3__["Utils"]();
        }

        _createClass(StatisticMainComponent, [{
          key: "ngOnInit",
          value: function ngOnInit() {
            this.labels = this.month.map(function (x) {
              return x.month;
            });
            this.length = this.month.map(function (x) {
              return x.noteStats.length;
            });
            this.win = this.month.map(function (x) {
              return x.noteStats.medical.winner;
            });
            this.loss = this.month.map(function (x) {
              return x.noteStats.medical.looser;
            });
            this.retired = this.month.map(function (x) {
              return x.noteStats.medical.retired;
            });
            this.nMretired = this.month.map(function (x) {
              return x.noteStats.stats.nmRetires;
            });
            this.fSretired = this.month.map(function (x) {
              return x.noteStats.medical.fsRetired;
            });
            this.check = this.win.reduce(function (a, b) {
              return a + b;
            }) + this.loss.reduce(function (a, b) {
              return a + b;
            }) + this.retired.reduce(function (a, b) {
              return a + b;
            }); // check avg
      ...
      StatisticMainComponent.ctorParameters = function () {
        return [];
      };
      ...
      StatisticMainComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
