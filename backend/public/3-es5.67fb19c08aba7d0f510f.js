(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([[3], {
    ...
    function p3(module, __webpack_exports__, __webpack_require__) {
      ...
      var _store_report_report_actions__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
      /*! ../../../store/report/report.actions */
      "DoIT");
      /* harmony import */


      var _services_strategy_report_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
      ...
      var ReportMainComponent = /*#__PURE__*/function () {
        function ReportMainComponent(router, store, strategyReportService) {
        ...
        _createClass(ReportMainComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.isLoadingAllRunners$ = this.store.pipe(Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_5__["select"])(_store_runners_runners_selectors__WEBPACK_IMPORTED_MODULE_7__["isLoadingAllRunners"])); // -- NEW TRADE --
            ...
            this.strategyDatatable$ = this.store.pipe(Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_5__["select"])(_store_report_report_selectors__WEBPACK_IMPORTED_MODULE_6__["getStrategyDatatable"])); // filtered
            ...
            this.compareStatus$ = this.store.pipe(Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_5__["select"])(_store_report_report_selectors__WEBPACK_IMPORTED_MODULE_6__["getCompareStatus"])); // generate strategyReport

            var var$ = Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["combineLatest"])([this.selectedStrategy$, this.selectedStrategyTrades$]).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_10__["takeUntil"])(this.destroy$)).subscribe(function (data) {
              if (data[0] && data[1].length) {
                var strategy = data[0];
                var trades = data[1]; // set the data in service

                _this.strategyReportService.setData(strategy, trades);

                _this.selectedStrategyReport = _this.strategyReportService.getStrategyReport();
                _this.selectedStrategyPie = _this.strategyReportService.getStrategyPie(); // visible presentational components

                _this.visibleReport = true;
              } else {
                _this.visibleReport = false;
              }
    ...
    /***/
    function TDb(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function ld1(module, __webpack_exports__, __webpack_require__) {
      "use strict";
        ...
        _createClass(StrategyCreateModalComponent, [{
          ...
          value: function openVerticalCenteredModal(content) {
            ...
            this.modalService.open(content, {
              ...
              _this4.addStrategyCreateEmitter.emit([_this4.strategy, result]);
            })["finally"](function () {
              // reset for next input
              _this4.constructStrategy();
            });
          }
        }, {
    ...
    function OF(module, __webpack_exports__, __webpack_require__) {
      ...
      var _components_strategy_strategy_datatable_strategy_datatable_component__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(
      /*! ./components/strategy/strategy-datatable/strategy-datatable.component */
      "eLsF");
      /* harmony import */
      ...
      var _components_strategyUploader_strategy_uploader_main_component__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(
      /*! ./components/strategyUploader/strategy-uploader-main.component */
      "Sojj");
      /* harmony import */


      var _components_strategyUploader_strategy_uploader_insert_strategy_uploader_insert_component__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(
      /*! ./components/strategyUploader/strategy-uploader-insert/strategy-uploader-insert.component */
      "sOAS"); // ROUTER
        ...
        _createClass(StrategyUpdatesModalComponent, [{
          ...
          value: function openVerticalCenteredModal(content) {
            ...
            this.modalService.open(content, {
              ...
              _this5.strategyUpdateEmitter.emit([_this5.strategyOutput, result]);
            })["catch"](function (res) {});
          }
        }]);
    ...
    /***/
    function EyB9(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function KAN7(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function Sojj(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "StrategyUploaderMainComponent", function () {
        return StrategyUploaderMainComponent;
      });
      /* harmony import */
      ...
      var _raw_loader_strategy_uploader_main_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./strategy-uploader-main.component.html */
      "EyB9");
      /* harmony import */
      ...
      var StrategyUploaderMainComponent = /*#__PURE__*/function () {
        function StrategyUploaderMainComponent() {
          _classCallCheck(this, StrategyUploaderMainComponent);

          this.strategyUploaderMatch = [];
          this.defaultNavActiveId = 1;
        }

        _createClass(StrategyUploaderMainComponent, [{
          key: "ngOnInit",
          value: function ngOnInit() {}
        }, {
          key: "addNewMarket",
          value: function addNewMarket() {
          ...
          key: "deleteMarket",
          value: function deleteMarket(index) {
      ...
      StrategyUploaderMainComponent.ctorParameters = function () {
        return [];
      };

      StrategyUploaderMainComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
    ...
    /***/
    function TfeN(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function dode(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function eLsF(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var StrategyDatatableComponent = /*#__PURE__*/function () {
        ...
        _createClass(StrategyDatatableComponent, [{
          ...
          value: function updateFilter(event) {
            ...
            console.log(val); // filter our data
            // update the rows

            this.rows = this.strategyDatatable.filter(function (d) {
    ...
    /***/
    function pid3(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    function sOAS(module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, "StrategyUploaderInsertComponent", function () {
        return StrategyUploaderInsertComponent;
      });
      /* harmony import */
      ...
      var _raw_loader_strategy_uploader_insert_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./strategy-uploader-insert.component.html */
      "dode");
      /* harmony import */
      ...
      var StrategyUploaderInsertComponent = /*#__PURE__*/function () {
        function StrategyUploaderInsertComponent() {
          _classCallCheck(this, StrategyUploaderInsertComponent);

          this.deleteMarketEmitter = new _angular_core__WEBPACK_IMPORTED_MODULE_2__["EventEmitter"]();
        }

        _createClass(StrategyUploaderInsertComponent, [{
          key: "ngOnInit",
          value: function ngOnInit() {}
        }, {
          key: "deleteMarket",
          value: function deleteMarket() {
      ...
      StrategyUploaderInsertComponent.ctorParameters = function () {
        return [];
      };
      ...
      StrategyUploaderInsertComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
