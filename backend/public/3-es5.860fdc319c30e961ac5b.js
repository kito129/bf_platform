      ...
      var ReportMainComponent = /*#__PURE__*/function () {
        ...
        _createClass(ReportMainComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.allTrade$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_10__["takeUntil"])(this.destroy$)).subscribe(function (trades) {
              var i = 0;
              _this.allTradesLabels = trades.map(function (x) {
                i++;
        ...
        _createClass(StrategyDeleteModalComponent, [{
          ...
          value: function openVerticalCenteredModal(content) {
            ...
            this.modalService.open(content, {
              ...
              console.log(_this2.strategy._id);

              _this2.strategyDeleteEmitter.emit([_this2.strategy._id, result]);
            })["catch"](function (res) {});
          }
        }]);
        ...
        _createClass(StrategyCreateModalComponent, [{
          ...
          value: function openVerticalCenteredModal(content) {
            ...
            this.modalService.open(content, {
              ...
              _this3.addStrategyCreateEmitter.emit([_this3.strategy, result]);
            })["finally"](function () {
              // reset for next input
              _this3.constructStrategy();
            });
          }
        }, {
      ...
      var StrategyDatatableComponent = /*#__PURE__*/function () {
        ...
        _createClass(StrategyDatatableComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.temp = _toConsumableArray(this.strategyDatatable);
          }
        }, {
          key: "updateFilter",
