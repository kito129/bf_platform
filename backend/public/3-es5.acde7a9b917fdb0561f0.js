(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([[3], {
      ...
      var ReportMainComponent = /*#__PURE__*/function () {
        ...
        _createClass(ReportMainComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.strategyDatatable$ = this.store.pipe(Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_5__["select"])(_store_report_report_selectors__WEBPACK_IMPORTED_MODULE_6__["getStrategyDatatable"])); // generate strategyReport
    ...
    function eLsF(module, __webpack_exports__, __webpack_require__) {
      ...
      var _store_report_report_actions__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! ../../../../../store/report/report.actions */
      "DoIT");
      /* harmony import */
      ...
      var StrategyDatatableComponent = /*#__PURE__*/function () {
        ...
        _createClass(StrategyDatatableComponent, [{
          ...
          value: function createModal(event) {
            if (event[1] === 'create') {
              // CREATE runner note
              this.store.dispatch(_store_report_report_actions__WEBPACK_IMPORTED_MODULE_4__["createStrategy"]({
                strategy: event[0]
              }));
            }
          }
          ...
          value: function updateModal(event) {
            if (event[1] === 'update') {
              ...
              this.store.dispatch(_store_report_report_actions__WEBPACK_IMPORTED_MODULE_4__["updateStrategy"]({
                _id: event[0]._id,
                strategy: event[0]
              }));
            }
          ...
          value: function deleteModal(event) {
            if (event[1] === 'delete') {
              // DELETE runner note
              this.store.dispatch(_store_report_report_actions__WEBPACK_IMPORTED_MODULE_4__["deleteStrategy"]({
                _id: event[0]
              }));
            }
          }
          ...
          value: function clickSelectStrategy(id) {
            if (this.selectedStrategyId === id) {
              this.store.dispatch(_store_report_report_actions__WEBPACK_IMPORTED_MODULE_4__["setSelectedStrategy"]({
                _id: null
              }));
            } else {
              this.store.dispatch(_store_report_report_actions__WEBPACK_IMPORTED_MODULE_4__["setSelectedStrategy"]({
