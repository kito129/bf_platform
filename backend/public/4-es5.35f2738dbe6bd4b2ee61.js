(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([[4], {
      ...
      var ReportMainComponent = /*#__PURE__*/function () {
        ...
        _createClass(ReportMainComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.allSavedReports$ = this.store.pipe(Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_5__["select"])(_store_report_report_selectors__WEBPACK_IMPORTED_MODULE_6__["getSavedReport"]));
        ...
        _createClass(StrategyDeleteModalComponent, [{
          ...
          value: function openVerticalCenteredModal(content) {
            ...
            this.modalService.open(content, {
              ...
              console.log(_this.strategy._id);

              _this.strategyDeleteEmitter.emit([_this.strategy._id, result]);
            })["catch"](function (res) {});
          }
        }]);
        ...
        _createClass(StrategyCreateModalComponent, [{
          ...
          value: function openVerticalCenteredModal(content) {
            ...
            this.modalService.open(content, {
              ...
              _this2.addStrategyCreateEmitter.emit([_this2.strategy, result]);
            })["finally"](function () {
              // reset for next input
              _this2.constructStrategy();
            });
          }
        }, {
    ...
    function OF(module, __webpack_exports__, __webpack_require__) {
      ...
      var _components_saved_report_datatable_saved_report_datatable_component__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(
      /*! ./components/saved-report-datatable/saved-report-datatable.component */
      "lgBd"); // ROUTER
        ...
        _createClass(StrategyUpdatesModalComponent, [{
          ...
          value: function openVerticalCenteredModal(content) {
            ...
            this.modalService.open(content, {
              ...
              _this3.strategyUpdateEmitter.emit([_this3.strategyOutput, result]);
            })["catch"](function (res) {});
          }
        }]);
    ...
    "i3JA":
    /*!***********************************************************************************************************************************************!*\
      !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/features/report/components/saved-report-datatable/saved-report-datatable.component.html ***!
      \***********************************************************************************************************************************************/

    /*! exports provided: default */

    /***/
    function i3JA(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    "lgBd":
    /*!*******************************************************************************************************!*\
      !*** ./src/app/features/report/components/saved-report-datatable/saved-report-datatable.component.ts ***!
      \*******************************************************************************************************/

    /*! exports provided: SavedReportDatatableComponent */

    /***/
    function lgBd(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "SavedReportDatatableComponent", function () {
        return SavedReportDatatableComponent;
      });
      /* harmony import */
      ...
      var _raw_loader_saved_report_datatable_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./saved-report-datatable.component.html */
      "i3JA");
      /* harmony import */
      ...
      var SavedReportDatatableComponent = /*#__PURE__*/function () {
        function SavedReportDatatableComponent(store) {
          _classCallCheck(this, SavedReportDatatableComponent);
        ...
        _createClass(SavedReportDatatableComponent, [{
          key: "ngOnInit",
          value: function ngOnInit() {}
        }]);
      ...
      SavedReportDatatableComponent.ctorParameters = function () {
        return [{
          type: _ngrx_store__WEBPACK_IMPORTED_MODULE_4__["Store"]
        }];
      };

      SavedReportDatatableComponent.propDecorators = {
        savedReport: [{
          type: _angular_core__WEBPACK_IMPORTED_MODULE_2__["Input"]
        }],
        table: [{
      ...
      SavedReportDatatableComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
        selector: 'app-saved-report-datatable',
        template: _raw_loader_saved_report_datatable_component_html__WEBPACK_IMPORTED_MODULE_1__["default"],
        styles: ["/deep/ .datatable-row-even {background-color: #181818;}"]
      })], SavedReportDatatableComponent);
      /***/
    },
