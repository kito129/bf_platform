...
let StrategyDatatableComponent = class StrategyDatatableComponent {
    ...
    updateFilter() {
        ...
        if (val) {
            this.strategyDatatable = this.rows.filter((d) => {
                if (!this.isSaved) {
    ...
    addToCompareSavedReport(id) {
        this.store.dispatch(_store_report_report_actions__WEBPACK_IMPORTED_MODULE_5__["setSelectedStrategy"]({ _id: null }));
        if (this.compareSavedReportList.indexOf(id) !== -1) {
            this.store.dispatch(_store_report_report_actions__WEBPACK_IMPORTED_MODULE_5__["removeSavedReportInCompare"]({ savedReportId: id }));
        }
        else {
            this.store.dispatch(_store_report_report_actions__WEBPACK_IMPORTED_MODULE_5__["addSavedReportInCompare"]({ savedReportId: id, first: false }));
        }
    }
    compareSavedReport() {
        this.store.dispatch(_store_report_report_actions__WEBPACK_IMPORTED_MODULE_5__["setSelectedStrategy"]({ _id: null }));
    ...
    compareAllSavedReport() {
        ...
        const notEmpty = this.strategyDatatable.filter(x => x.numberOfTrade);
        for (const at of notEmpty) {
            this.store.dispatch(_store_report_report_actions__WEBPACK_IMPORTED_MODULE_5__["addSavedReportInCompare"]({ savedReportId: at._id, first: false }));
        }
        this.store.dispatch(_store_report_report_actions__WEBPACK_IMPORTED_MODULE_5__["setSelectedStrategy"]({ _id: null }));
        this.store.dispatch(_store_report_report_actions__WEBPACK_IMPORTED_MODULE_5__["compareSavedReport"]());
        this.search = '';
    ...
    firstToCompareSavedReport($event, id) {
        $event.preventDefault();
        if (this.compareList.indexOf(id) !== -1) {
            this.store.dispatch(_store_report_report_actions__WEBPACK_IMPORTED_MODULE_5__["removeSavedReportInCompare"]({ savedReportId: id }));
            this.store.dispatch(_store_report_report_actions__WEBPACK_IMPORTED_MODULE_5__["addSavedReportInCompare"]({ savedReportId: id, first: true }));
        }
        else {
            this.store.dispatch(_store_report_report_actions__WEBPACK_IMPORTED_MODULE_5__["addSavedReportInCompare"]({ savedReportId: id, first: true }));
        }
    ...
    duplicateSavedReport(savedReport) {
        ...
        this.store.dispatch(_store_report_report_actions__WEBPACK_IMPORTED_MODULE_5__["createSavedReport"]({ savedReport: temp }));
    }
};
...
StrategyDatatableComponent.propDecorators = {
    ...
    compareSavedReportList: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_2__["Input"] }],
    compareSavedReportStatus: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_2__["Input"] }],
