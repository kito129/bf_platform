...
/* harmony import */ var _services_compare_study_csv_generator_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../../../services/compare-study-csv-generator.service */ "Wh7M");
...
let TennisTournamentDataTableComponent = class TennisTournamentDataTableComponent {
    constructor(router, store, route, compareStudyCsv) {
        this.router = router;
        this.store = store;
        this.route = route;
    ...
    saveAsCSV() {
        const date = new Date();
        this.compareStudyCsv.exportToCsv(`${date.getMonth() + 1}_${date.getDate()}_${date.getFullYear()}_tennisTournament.csv`, JSON.parse(JSON.stringify(this.tennisTournaments.map(x => {
            return {
                id: x._id,
