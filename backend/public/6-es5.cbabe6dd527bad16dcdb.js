(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([[6], {
    ...
    function OJN(module, __webpack_exports__, __webpack_require__) {
      ...
      var _services_compare_study_csv_generator_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! ../../../../services/compare-study-csv-generator.service */
      "Wh7M");

      var TennisTournamentDataTableComponent = /*#__PURE__*/function () {
        function TennisTournamentDataTableComponent(router, store, route, compareStudyCsv) {
          _classCallCheck(this, TennisTournamentDataTableComponent);

          this.router = router;
          this.store = store;
          this.route = route;
          this.compareStudyCsv = compareStudyCsv;
          this.rows = [];
          this.temp = [];
        ...
        _createClass(TennisTournamentDataTableComponent, [{
          ...
          value: function saveAsCSV() {
            ...
            var date = new Date();
            this.compareStudyCsv.exportToCsv("".concat(date.getMonth() + 1, "_").concat(date.getDate(), "_").concat(date.getFullYear(), "_tennisTournament.csv"), JSON.parse(JSON.stringify(this.tennisTournaments.map(function (x) {
              return {
                id: x._id,
      ...
      TennisTournamentDataTableComponent.ctorParameters = function () {
        return [{
          ...
          type: _services_compare_study_csv_generator_service__WEBPACK_IMPORTED_MODULE_7__["CompareStudyCsvGeneratorService"]
        }];
      };
    ...
    function RnBh(module, __webpack_exports__, __webpack_require__) {
      ...
      var TennisTournamentModule = function TennisTournamentModule() {
