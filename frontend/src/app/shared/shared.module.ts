...
import { MarketInfoCardComponent } from './cards/marketCards/market-detail-info-card/market-detail-info-card.component';
import { MarketUpdateCardComponent } from './cards/marketCards/market-update-card/market-update-card.component';
import { MarketRunnersCardComponent } from './cards/marketCards/market-runners-card/market-runners-card.component';
...
import { StudyTradesDatatableComponent } from './tables/trade-datatable/study-trades-datatable.component';
import { TradeRowDetailSharedComponent } from './tables/trade-datatable/trade-row-detail-shared/trade-row-detail-shared.component';
...
import { StrategyReportInfoComponent } from './study/strategy-report/strategy-report-info/strategy-report-info.component';
import { StrategyReportResumeComponent } from './study/strategy-report/strategy-report-resume/strategy-report-resume.component';
import { StrategyReportComponent } from './study/strategy-report/strategy-report.component';
import { StrategyReportExpectedValueComponent } from './study/strategy-report/strategy-report-expected-value/strategy-report-expected-value.component';
...
import { StrategyReportDdComponent } from './study/strategy-report/strategy-report-dd/strategy-report-dd.component';
...
import { StrategyReportMonthComponent } from './study/strategy-report/strategy-report-month/strategy-report-month.component';
import { StrategyReportTablesComponent } from './study/strategy-report/strategy-report-tables/strategy-report-tables.component';
...
import { MarketAdvancedDatatableComponent } from './tables/advanced/market-list/market-advanced-datatable.component';
import { SecAndMinutePipe } from '../core/pipe/sec-and-minute.pipe';
import { TradeBetsViewComponent } from './report/trade-bets-view/trade-bets-view.component';
...
import { MarketAdditionalInfoComponent } from './cards/marketCards/market-additional-info/market-additional-info.component';
import {MarketAdvancedMetalistStatsComponent} from './cards/marketCards/market-advanced-metalist-stats/market-advanced-metalist-stats.component';

import {MarketDetailsModalComponent} from './cards/marketCards/marke-basic-detail-modal/market-details-modal.component';
import {MarketDetailPointComponent} from './cards/marketCards/market-detail-point/market-detail-point.component';
import {MarketDetailPricesAnalysisComponent} from './cards/marketCards/market-detail-prices-analysis/market-detail-prices-analysis.component';
import {MarketDetailSameMatchComponent} from './cards/marketCards/market-detail-same-match/market-detail-same-match.component';

import {MarketPricesComponent} from './charts/tradingView-charts/market-detail-prices/market-prices.component';

import {MarketsDetailComponent} from './cards/marketCards/market-basic-details/markets-detail.component';

import {MarketAdvancedDetailComponent} from './cards/marketCards/market-advanced-detail/market-advanced-detail.component';
...
import { TradeAndMarketDetailsModalComponent } from './tradeCards/trade-and-market-details-modal/trade-and-market-details-modal.component';
...
import { TradeToolsActionsComponent } from './tradeCards/trade-tools-actions/trade-tools-actions.component';

import {TradeCreateModalComponent} from './tradeCards/modal/trade-create-modal/trade-create-modal.component';
import {TradeUpdatesModalComponent} from './tradeCards/modal/trade-updates-modal/trade-updates-modal.component';
import {TradeDatatableComponent} from './tradeCards/trade-datatable/trade-datatable.component';
import {TradeRowDetailComponent} from './tradeCards/trade-datatable/trade-row-detail/trade-row-detail.component';
import { CrudListComponent } from './filters/crud-list/crud-list.component';
import { StrategyCompareComponent } from './study/strategy-compare/strategy-compare.component';
import { StrategyCompareReportComponent } from './study/strategy-compare/strategy-compare-report/strategy-compare-report.component';
...
@NgModule({
  ...
  declarations: [
    ...
    StudyListComponent,
    StudyTradesDatatableComponent,
    StudyTradesDatatableComponent,
    TradeRowDetailSharedComponent,
