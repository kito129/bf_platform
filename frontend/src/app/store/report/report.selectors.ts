...
export const getPassiveLiveData = (wantStrategy: boolean) => createSelector(
  getReportState,
  (state) => {
    const strategyId = ['6302694381d88c06aa419668','6302697481d88c06aa41966c','6302696081d88c06aa41966a','630269a181d88c06aa419670','6302698781d88c06aa41966e','6317c21975f1fd3184bbb9c5', '6317c22d75f1fd3184bbb9c7']
    return filterStrategyDatatable(state.allStrategy, state.allNewTrades, wantStrategy, strategyId)
